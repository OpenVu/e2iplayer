...
class AkoAm(CBaseHostClass):
    ...
    def getArticleContent(self, cItem):
        ...
        descTabMap = {"Ø§ÙÙØ¯Ø© Ø§ÙØ²ÙÙÙØ©":     "duration",
                      "Ø³ÙØ© Ø§ÙØ§ÙØªØ§Ø¬":        "year",
                      "ÙØ­ØªÙÙ Ø§ÙÙÙÙÙ":      "genre",
                      "Ø§ÙÙØºØ©":             "language",
                      "Ø¬ÙØ¯Ø© Ø§ÙØµÙØ±Ø©":       "quality"}
        ...
        descTabMap = {"Ø¨Ø·ÙÙØ© Ø§ÙÙÙÙÙ":     "actors",
                      "ïºïº§ïº®Ø§ïº":            "director",
                      "ïºïºï»ï»´ï»":            "writers",
                      "Ø§ÙØªØµÙÙÙ":          "categories",
                      }
