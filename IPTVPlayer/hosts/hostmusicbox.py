...
def GetConfigList():
    optionList = []
    optionList.append(getConfigListEntry("UÅ¼ytkownik Last.fm", config.plugins.iptvplayer.MusicBox_premium))
...
###############################################################################
    ...
    def Itunes_track_charts(self, url):
        ...
        try:
            ...
            printExc()  # wypisz co poszÅo nie tak
...
###############################################################################
# Szukanie linku do materiaÅu na youtube
###############################################################################
