...
config.plugins.iptvplayer.gitlab_repo = ConfigSelection(default = "9thprince", choices = [("mosz_nowy", "mosz_nowy"),("9thprince", "9thprince"),("zadmario", "zadmario"),("maxbambi", "maxbambi")])
